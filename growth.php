...
$growth = [100000, 120000, 115000, 130000, 150000, 140000, 160000, 155000, 170000, 180000]; // Monthly revenue growth in pesos
?>
    ...
    <script>
        window.onload = function () { // Ensure the script runs after the page is loaded
            ...
            const growthChart = new Chart(ctx, {
                ...
                data: {
                    labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct'], // Months
                    datasets: [{

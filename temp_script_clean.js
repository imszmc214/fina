    <script>
    // Global variables
    let tnvsCategories = 0;
    
    // Hierarchical COA Data for Modal
    const modalCategories = 0;
    const modalSubcategories = 0;
    const modalGLAccounts = 0;
    ...
    */
    ...
    async function loadMonitoringData() {
        ...
        if (currentMonitoringView === 'department') {
            year = document.getElementById('deptMonitoringYear')?.value || 0;
            department = document.getElementById('deptMonitoringDepartment')?.value || '';
        } else {
            year = document.getElementById('monitoringYear')?.value || 0;
